...
PERIOD = "3y"   # افزایش دوره به 3 سال برای داده‌های بیشتر
...
def create_target(df):
    ...
    atrs = df['ATRr_14'].values if 'ATRr_14' in df.columns else df['ATR_14'].values
...
if __name__ == "__main__":
    ...
    for symbol in SYMBOLS:
        ...
        df_symbol = yf.download(symbol, period=PERIOD, interval=INTERVAL, progress=False)
    ...
    if not all_data:
        print("❌ Error: Could not download data for any symbol.")
        exit()
    ...
    print("🧠 Training Models on ALL 5 Symbols Combined...")
    ...
    print("\n✅ Done! General Models updated using combined data (All 5 symbols).")
