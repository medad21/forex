...
API_KEY_ALPHA = "W1L3K1JN4F77T9KL"              # کلید آلفا ونتیج (برای اخبار دقیق هوش مصنوعی)
API_KEY_FINNHUB = "d4gd4r9r01qm5b352il0d4gd4r9r01qm5b352ilg"                  # کلید فین‌هاب (برای اخبار پشتیبان)
# ---------------------------------------------------------
